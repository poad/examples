...
import org.bitbucket.poad1010.example.springboot.batch.exception.UncheckedGeneralSecurityException;
...
public abstract class Identifier implements org.bitbucket.poad1010.example.springboot.batch.entity.Entity, Serializable {
    @Column(name = "id")
    @Id
    private String id;
