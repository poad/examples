package org.bitbucket.poad1010.example.springboot.jpa.entity;
...
public abstract class Identifier implements org.bitbucket.poad1010.example.springboot.jpa.entity.Entity, Serializable {
    @Column(name = "id")
    @Id
    private String id;
